...
//Middleware
const { auth, AdminCheck, StaffCheck } = require("../middleware/AuthCheck"); // Must has token for access
...
//@Endpoint https://localhost:4000/api/auth/current-staff
//@Method   POST
//@Access   Private
router.post("/auth/current-staff", auth, StaffCheck, GetProfile);
